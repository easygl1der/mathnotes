...
\newtheorem*{pf}{Proof}
\surroundwithmdframed[style=solutionstyle]{pf}
\renewenvironment{proof}{\begin{pf}}{\end{pf}}
...
\pagelayout{wide}
\addpartwithbg{大二上}{elias-maurer-1D5KHvFBVSs-unsplash}
\pagelayout{margin}
...
\setchapterstyle{kao} % 选择默认的章节标题样式
\pagelayout{wide}
\addpartwithbg{大二下}{elias-maurer-ykwP1X61zbU-unsplash}
\pagelayout{margin}
...
\input{../近世代数/includes/semi-product.tex}
